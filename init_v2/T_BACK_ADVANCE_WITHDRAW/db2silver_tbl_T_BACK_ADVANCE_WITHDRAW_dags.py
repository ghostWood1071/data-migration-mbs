...
with DAG(
    dag_id="spark_db2silver_tbl_T_BACK_ADVANCE_WITHDRAW",
    ...
    load_from_db_to_silver = SparkSubmitOperator(
        task_id="db2silver_tbl_T_BACK_ADVANCE_WITHDRAW",
        application="s3a://asset/spark-jobs/db2silver_tbl_T_BACK_ADVANCE_WITHDRAW.py",
        deploy_mode="cluster",
        name="spark-db2silver_tbl_T_BACK_ADVANCE_WITHDRAW",
        conn_id="spark_k8s",
        conf={
