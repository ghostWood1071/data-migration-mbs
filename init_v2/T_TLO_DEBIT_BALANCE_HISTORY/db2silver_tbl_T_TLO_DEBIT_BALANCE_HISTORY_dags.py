...
with DAG(
    ...
    load_from_db_to_silver = SparkSubmitOperator(
        task_id="db2silver_layer_tbl_T_TLO_DEBIT_BALANCE_HISTORY",
        application="s3a://asset/spark-jobs/db2silver_tbl_T_TLO_DEBIT_BALANCE_HISTORY.py",
        deploy_mode="cluster",
        name="spark-db2silver_T_TLO_DEBIT_BALANCE_HISTORY",
        conn_id="spark_k8s",
        conf={
