...
silver_df = (
    T_TLO_DEBIT_BALANCE_HISTORY_df.withColumn("partition_date", to_date("C_TRANSACTION_DATE", "yyyy-MM-dd"))
...
spark.sql("DROP TABLE IF EXISTS silver.fact_T_TLO_DEBIT_BALANCE_HISTORY")
