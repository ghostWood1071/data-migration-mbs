...
with DAG(
    dag_id="spark_db2silver_layer_view_V_T_LIST_FRONT_USER",
    ...
    load_from_db_to_silver = SparkSubmitOperator(
        task_id="db2silver_layer_view_V_T_LIST_FRONT_USER",
        application="s3a://asset/spark-jobs/db2silver_view_V_T_LIST_FRONT_USER.py",
        deploy_mode="cluster",
        name="spark-db2silver_view_V_T_LIST_FRONT_USER",
        conn_id="spark_k8s",
        conf={
