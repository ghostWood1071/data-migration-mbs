...
with DAG(
    ...
    load_from_db_to_silver = SparkSubmitOperator(
        task_id="db2silver_layer_view_V_T_ERC_MONTHLY_DETAIL",
        application="s3a://asset/spark-jobs/db2silver_view_V_T_ERC_MONTHLY_DETAIL.py",
        deploy_mode="cluster",
        name="spark-db2silver_view_V_T_ERC_MONTHLY_DETAIL",
        conn_id="spark_k8s",
        conf={
