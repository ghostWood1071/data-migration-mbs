...
with DAG(
    dag_id="spark_db2silver_tbl_T_MARGIN_EXTRA_BALANCE_HIS",
    ...
    load_from_db_to_silver = SparkSubmitOperator(
        task_id="db2silver_tbl_T_MARGIN_EXTRA_BALANCE_HIS",
        application="s3a://asset/spark-jobs/db2silver_tbl_T_MARGIN_EXTRA_BALANCE_HIS.py",
        deploy_mode="cluster",
        name="spark-db2silver_tbl_T_MARGIN_EXTRA_BALANCE_HIS",
        conn_id="spark_k8s",
        conf={
