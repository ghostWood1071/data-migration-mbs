...
with DAG(
    dag_id="spark_db2starrocks_view_V_T_BACK_ACCOUNT",
    ...
    load_from_db_to_starrocks = SparkSubmitOperator(
        task_id="db2starrocks_view_V_T_BACK_ACCOUNT",
        application="s3a://asset/spark-jobs/db2starrocks_view_V_T_BACK_ACCOUNT.py",
        deploy_mode="cluster",
        name="spark-db2starrocks_view_V_T_BACK_ACCOUNT",
        conn_id="spark_k8s",
        conf={
