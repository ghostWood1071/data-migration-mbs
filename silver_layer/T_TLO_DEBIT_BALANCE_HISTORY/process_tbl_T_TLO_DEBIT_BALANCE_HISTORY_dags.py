...
with DAG(
    dag_id="spark_process_silver_layer_tbl_T_TLO_DEBIT_BALANCE_HISTORY",
    ...
    process_silver_layer = SparkSubmitOperator(
        task_id="process_silver_layer_tbl_T_TLO_DEBIT_BALANCE_HISTORY",
        application="s3a://asset/spark-jobs/process_tbl_T_TLO_DEBIT_BALANCE_HISTORY.py",
        deploy_mode="cluster",
        name="spark-process-silver_tbl_T_TLO_DEBIT_BALANCE_HISTORY",
        conn_id="spark_k8s",
        conf={
