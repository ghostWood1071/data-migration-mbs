...
#     remove_test_tbl = SparkSubmitOperator(
#         task_id="remove_test_tbl",
#         application="s3a://asset/spark-jobs/remove_test_tbl.py",
#         deploy_mode="cluster",
#         name="spark_remove_test_tbl",
#         conn_id="spark_k8s",
#         conf={
