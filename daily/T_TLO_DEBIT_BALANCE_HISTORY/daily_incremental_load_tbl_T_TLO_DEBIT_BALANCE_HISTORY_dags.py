...
with DAG(
    ...
    daily_incremental_load = SparkSubmitOperator(
        task_id="daily_incremental_load_tbl_T_TLO_DEBIT_BALANCE_HISTORY",
        application="s3a://asset/spark-jobs/daily_incremental_load_tbl_T_TLO_DEBIT_BALANCE_HISTORY.py",
        deploy_mode="cluster",
        name="spark-daily-incremental-load-tbl_T_TLO_DEBIT_BALANCE_HISTORY",
        conn_id="spark_k8s",
        conf={
