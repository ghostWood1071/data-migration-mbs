...
with DAG(
    dag_id="spark_daily_incremental_load_tbl_T_BACK_DEAL_HISTORY",
    ...
    daily_incremental_load = SparkSubmitOperator(
        task_id="daily_incremental_load_tbl_T_BACK_DEAL_HISTORY",
        application="s3a://asset/spark-jobs/daily_incremental_load_tbl_T_BACK_DEAL_HISTORY.py",
        deploy_mode="cluster",
        name="spark-daily-incremental-load-tbl_T_BACK_DEAL_HISTORY",
        conn_id="spark_k8s",
        conf={
