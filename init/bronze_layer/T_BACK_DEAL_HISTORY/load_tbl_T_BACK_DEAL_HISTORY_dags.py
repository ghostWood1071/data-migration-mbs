...
# with DAG(
#     dag_id="spark_process_bronze_layer_tbl_T_BACK_DEAL_HISTORY",
...
#         task_id="process_bronze_layer_tbl_T_BACK_DEAL_HISTORY",
#         application="s3a://asset/spark-jobs/load_tbl_T_BACK_DEAL_HISTORY.py",
#         deploy_mode="cluster",
#         name="spark-process-bronze_tbl_T_BACK_DEAL_HISTORY",
#         conn_id="spark_k8s",
#         conf={
