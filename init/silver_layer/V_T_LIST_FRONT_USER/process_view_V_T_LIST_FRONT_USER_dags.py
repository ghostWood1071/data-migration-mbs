...
with DAG(
    dag_id="spark_process_silver_layer_view_V_T_LIST_FRONT_USER",
    ...
    process_silver_layer = SparkSubmitOperator(
        task_id="process_silver_layer_view_V_T_LIST_FRONT_USER",
        application="s3a://asset/spark-jobs/process_view_V_T_LIST_FRONT_USER.py",
        deploy_mode="cluster",
        name="spark-process-silver_view_V_T_LIST_FRONT_USER",
        conn_id="spark_k8s",
        conf={
