...
with DAG(
    dag_id="spark_monthly_incremental_load_tbl_DIM_ERC_RANKING",
    ...
    daily_incremental_load = SparkSubmitOperator(
        task_id="monthly_incremental_load_tbl_DIM_ERC_RANKING",
        application="s3a://asset/spark-jobs/monthly_incremental_load_tbl_DIM_ERC_RANKING.py",
        deploy_mode="cluster",
        name="spark-monthly_incremental_load_tbl_DIM_ERC_RANKING",
        conn_id="spark_k8s",
        conf={
