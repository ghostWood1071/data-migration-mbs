...
fact_t_margin_extra_balance_his_df = get_data_from_starrocks("fact_t_margin_extra_balance_his")
fact_t_tlo_debit_balance_history_df = get_data_from_starrocks("fact_t_tlo_debit_balance_history")
fact_t_back_advance_withdraw_df = get_data_from_starrocks("fact_t_back_advance_withdraw")
fact_t_back_deal_history_df = get_data_from_starrocks("fact_t_back_deal_history")
